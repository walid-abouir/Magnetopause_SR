...
#ajout du bruit sur notre training set
#faut-il ajouter du bruit sur le facteur Pd ? Bz ? les deux ? 

bruit = 0.1 
X_bruit = X + np.random.normal(0,bruit,size=X.shape)

#modéle bruité avec tanh comme opérateur 
...
model.fit(X_bruit,y,weights=training_set["weight_98"])